            ...
            Center(
              child: InkWell(
                onTap: ()
                {
                  ...
                  // 1. kiểm tra mặt hàng có tồn tại trong giỏ hàng chưa
                  separateItemIDsList.contains(widget.model!.itemID)
                      ? Fluttertoast.showToast(msg: "Món ăn đã có trong giỏ hàng")
                      :
                  // 2. Nếu đã tồn tại thì thông báo cho người dùng nó đã có trong giỏ hàng
                  // tức là (thêm cùng 1 mặt hàng vào giỏ hàng)
